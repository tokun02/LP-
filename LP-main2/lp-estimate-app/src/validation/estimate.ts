...
export const estimateSchema = z.object({
  ...
  seoImportance: z.string().optional(),
  targetKeywords: z.string().optional(),
  currentMarketing: z.array(z.string()).optional(),
  snsIntegration: z.array(z.string()).optional(),
  ga4Status: z.string().optional(),
  domainChoice: z.string().optional(),
  domainExisting: z.string().optional(),
  serverChoice: z.string().optional(),
  sslChoice: z.string().optional(),
  devicesSupported: z.array(z.string()).optional(),
  maintenanceContract: z.string().optional(),
  backupChoice: z.string().optional(),
  securityImportance: z.string().optional(),
